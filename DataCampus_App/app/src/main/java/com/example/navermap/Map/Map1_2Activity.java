...
import com.example.navermap.databinding.ActivityMap12Binding;
...
public class Map1_2Activity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    // Data binding
    public ActivityMap12Binding binding = null;;
...
//    ---------------------------------------------------------------------------------------------------------
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_map1_2);
        setPoints();
    ...
    private List<MapPoint> setPoints() {
        ...
        mapPoint.add(new MapPoint("괴정네거리", 36.3348, 127.3805));
        mapPoint.add(new MapPoint("한민시장", 36.332524, 127.383228));
...
//            resulttext.setText(result);
    ...
    private void initializePersistentBottomSheet() {
        ...
        bottomSheetLayout = findViewById(R.id.bottom_sheet_layout1_2);
            ...
            public void onStateChanged(@NonNull View bottomSheet, int newState) {
                ...
                switch (newState) {
                    case BottomSheetBehavior.STATE_HIDDEN:
                        Log.d("Map1_2Activity", "state: hidden");
                        break;
                    case BottomSheetBehavior.STATE_EXPANDED:
                        Log.d("Map1_2Activity", "state: expanded");
                        break;
                    case BottomSheetBehavior.STATE_COLLAPSED:
                        Log.d("Map1_2Activity", "state: collapsed");
                        break;
                    case BottomSheetBehavior.STATE_DRAGGING:
                        Log.d("Map1_2Activity", "state: dragging");
                        break;
                    case BottomSheetBehavior.STATE_SETTLING:
                        Log.d("Map1_2Activity", "state: settling");
                        break;
                    case BottomSheetBehavior.STATE_HALF_EXPANDED:
                        Log.d("Map1_2Activity", "state: half expanded");
                        break;
                }
            }
